...
const it = {
  ...
  sectionFlightData: 'API E DEBUG',
  flightProviderSettingsTitle: 'API e debug voli',
  flightProviderSettingsSub: 'Scegli provider, salva API key, apri StaffMonitor e controlla l’ultimo debug.',
  ...
  flightProviderAutoSub: 'Combina i provider finché copre oggi e domani: AirLabs, StaffMonitor, FR24 API e FR24 pubblico.',
...
const en: typeof it = {
  ...
  sectionFlightData: 'APIS & DEBUG',
  flightProviderSettingsTitle: 'Flight APIs & debug',
  flightProviderSettingsSub: 'Choose providers, save API keys, open StaffMonitor and inspect the latest debug.',
  ...
  flightProviderAutoSub: 'Combines providers until today and tomorrow are covered: AirLabs, StaffMonitor, FR24 API and FR24 public.',
  flightProviderStaffMonitor: 'StaffMonitor PSA',
