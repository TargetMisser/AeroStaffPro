...
const it = {
  ...
  flightAccessibilityPinHint: 'Aggiunge il volo alla sezione in primo piano',
  flightAccessibilityUnpinHint: 'Rimuove il volo dalla sezione in primo piano',
  flightOpenExternal: 'Apri su Flightradar24',
...
const en: typeof it = {
  ...
  flightAccessibilityPinHint: 'Adds the flight to the pinned section',
  flightAccessibilityUnpinHint: 'Removes the flight from the pinned section',
  flightOpenExternal: 'Open on Flightradar24',
