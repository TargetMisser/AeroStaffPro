...
const it = {
  ...
  flightProviderAutoSub: 'Combina i provider finché copre oggi e domani: StaffMonitor, FR24 API, AeroDataBox, FR24 pubblico e AirLabs.',
...
const en: typeof it = {
  ...
  flightProviderAutoSub: 'Combines providers until today and tomorrow are covered: StaffMonitor, FR24 API, AeroDataBox, FR24 public and AirLabs.',
  flightProviderStaffMonitor: 'StaffMonitor PSA',
