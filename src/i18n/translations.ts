...
const it = {
  ...
  flightProviderAutoSub: 'Prova AirLabs se configurato, poi StaffMonitor, FR24 API e FR24 pubblico.',
...
const en: typeof it = {
  ...
  flightProviderAutoSub: 'Tries AirLabs when configured, then StaffMonitor, FR24 API and FR24 public.',
  flightProviderStaffMonitor: 'StaffMonitor PSA',
