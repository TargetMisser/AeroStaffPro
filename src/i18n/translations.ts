...
const it = {
  ...
  flightProviderKeysTitle: 'API KEY',
  ...
  fr24ModalCopy: 'Incolla una API key FlightRadar24 ufficiale. Resta nel SecureStore del telefono; se non va, resta il fallback pubblico.',
...
const en: typeof it = {
  ...
  flightProviderKeysTitle: 'API KEYS',
  ...
  fr24ModalCopy: 'Paste an official FlightRadar24 API key. It stays in the phone SecureStore; if it fails, the public fallback remains available.',
  fr24ModalLabel: 'API key',
