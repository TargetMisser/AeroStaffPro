...
const it = {
  ...
  flightProviderAutoSub: 'Prova AirLabs se configurato, poi StaffMonitor e FR24.',
  ...
  flightProviderFr24Sub: 'Best effort: può essere bloccato o limitato, ma resta utile come fallback.',
  ...
  flightAccessibilityPin: 'Pinnare volo',
  flightAccessibilityUnpin: 'Rimuovere pin',
  flightAccessibilityPinHint: 'Pinnare questo volo per ricevere avvisi e tenerlo in alto.',
  flightAccessibilityUnpinHint: 'Rimuovere questo volo dalla sezione pinnata.',
...
const en: typeof it = {
  ...
  flightProviderAutoSub: 'Tries AirLabs when configured, then StaffMonitor and FR24.',
  flightProviderStaffMonitor: 'StaffMonitor PSA',
  ...
  flightProviderFr24: 'FlightRadar24',
  flightProviderFr24Sub: 'Best effort: may be blocked or limited, but stays useful as fallback.',
  ...
  flightAccessibilityPinHint: 'Pins this flight to receive alerts and keep it at the top.',
  flightAccessibilityUnpinHint: 'Removes this flight from the pinned section.',
